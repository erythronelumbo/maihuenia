...
static_assert(
  mhn::equal_types_t<
    typename mhn::at_key<my_map, mhn::char_<'D'>>::type,
    STR_("Delta")
  >::value,
  "!!!"
);
static_assert(
  mhn::equal_types_t<
    typename mhn::at_key<my_map, mhn::char_<'?'>>::type,
...
static_assert(
  mhn::equal_types_t<
    typename mhn::at_key<my_set, mhn::char_<'e'>>::type,
    mhn::char_<'e'>
  >::value,
  "!!!"
);
static_assert(
  mhn::equal_types_t<
    typename mhn::at_key<my_set, mhn::char_<'?'>>::type,
    mhn::index_out_of_range
  >::value,
  "!!!"
);
