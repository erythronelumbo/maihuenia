...
using nums = mhn::vector_c<
  std::int32_t,
  103, 27, 165, 175, 255, 94, 2, 76, 247, 152, 144, 191, 254, 84, 31, -1, 49,
  138, 98, 44, 191, 98, 25, 17, 141, 130, 0, 243, 206, 19, 219, 223
>;

using res = mhn::take_while<
  nums,
  mhn::bind<mhn::quote<mhn::greater_equal>, _1, mhn::i32_c<0>>
>;
...
static_assert(
  mhn::equals_t<
    mhn::vector_c<
      std::int32_t,
      103, 27, 165, 175, 255, 94, 2, 76, 247, 152, 144, 191, 254, 84, 31
    >,
    typename res::type
  >::value,
  "!!!"
