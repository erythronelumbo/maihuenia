...
int main()
{
  ...
  static_assert(!mhn::any_of<tv1, geq5>::type::value, "!!!");
  static_assert(mhn::any_of<tv2, geq5>::type::value, "!!!");
  static_assert(mhn::any_of<tv3, geq5>::type::value, "!!!");
  static_assert(!mhn::any_of<tv4, geq5_>::type::value, "!!!");
