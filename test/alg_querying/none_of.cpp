...
int main()
{
  ...
  static_assert(mhn::none_of<tv1, geq5>::type::value, "!!!");
  static_assert(!mhn::none_of<tv2, geq5>::type::value, "!!!");
  static_assert(!mhn::none_of<tv3, geq5>::type::value, "!!!");
  static_assert(mhn::none_of<tv4, geq5_>::type::value, "!!!");
