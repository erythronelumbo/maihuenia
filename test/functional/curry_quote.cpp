...
using curried1a = typename mhn::curry_quote<
  dummy, 1
>::template apply<
  x0
>::type;

using curried2a = typename mhn::curry_quote<
  dummy, 2
>::template apply<
  x0, x1
>::type;

using curried2b = typename mhn::curry_quote<
  dummy, 2
>::template apply<
  x0
>::template apply<
...
using curried3a = typename mhn::curry_quote<
  dummy, 3
>::template apply<
  x0, x1, x2
>::type;

using curried3b = typename mhn::curry_quote<
  dummy, 3
>::template apply<
  x0
>::template apply<
...
using curried3c = typename mhn::curry_quote<
  dummy, 3
>::template apply<
  x0, x1
>::template apply<
...
using curried3d = typename mhn::curry_quote<
  dummy, 3
>::template apply<
  x0
>::template apply<
...
using curried4a = typename mhn::curry_quote<
  dummy, 4
>::template apply<
  x0, x1, x2, x3
>::type;

using curried4b = typename mhn::curry_quote<
  dummy, 4
>::template apply<
  x0
>::template apply<
...
using curried4c = typename mhn::curry_quote<
  dummy, 4
>::template apply<
  x0, x1, x2
>::template apply<
...
using curried4d = typename mhn::curry_quote<
  dummy, 4
>::template apply<
  x0, x1
>::template apply<
...
using curried4e = typename mhn::curry_quote<
  dummy, 4
>::template apply<
  x0
>::template apply<
...
using curried4f = typename mhn::curry_quote<
  dummy, 4
>::template apply<
  x0
>::template apply<
