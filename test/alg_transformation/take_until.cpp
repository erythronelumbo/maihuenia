...
void test_take_until()
{
  ...
  test_eq_types<
    typename mhn::take_until<
      ...
      equals_zero
    >::type,
    mhn::make_seq_t<SeqTag, x7, x9, x8>
  >();
...
int main()
{
  test_take_until<mhn::vector_tag>();
  test_take_until<mhn::string_tag>();
  test_take_until<mhn::linked_list_tag>();
