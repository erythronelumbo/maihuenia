...
void test_drop_while_ints()
{
  test_eq_types<
    typename mhn::drop_while<
...
int main()
{
  test_drop_while_ints<mhn::vector_tag>();
  test_drop_while_ints<mhn::string_tag>();
  test_drop_while_ints<mhn::linked_list_tag>();
