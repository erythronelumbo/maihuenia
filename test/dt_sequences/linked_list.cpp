...
{
  template <typename X>
  using apply = mhn::cons<X, mhn::cons<X>>;
};

struct monadic_fn_2
{
  template <typename X>
  using apply = mhn::null_type;
};
...
>;
using lst5 = mhn::cons<x5, mhn::cons<x6>>;
...
int main()
{
  ...
  test_eq_types<typename mhn::pop_front<lst1>::type, mhn::null_type>();
  test_eq_types<typename mhn::pop_front<lst2>::type, mhn::null_type>();
  test_eq_types<
  ...
  test_eq_types<
    ...
    mhn::cons<x1, mhn::cons<x2, mhn::cons<x3, mhn::cons<x4>>>>
  >();
  ...
  test_eq_types<
    typename mhn::make_seq<mhn::linked_list_tag>::type,
    lst1
  >();
  test_eq_types<
    typename mhn::make_seq<mhn::linked_list_tag, x0>::type,
    lst2
  >();
  test_eq_types<
    typename mhn::make_seq<mhn::linked_list_tag, x0, x1>::type,
    lst3
  >();
  test_eq_types<
    typename mhn::make_seq<mhn::linked_list_tag, x0, x1, x2, x3, x4>::type,
    lst4
  >();
  ...
  test_eq_types<
    ...
    mhn::cons<x0, mhn::cons<x1, mhn::cons<x5, mhn::cons<x6>>>>
  >();
  test_eq_types<
    typename mhn::concat<lst3, lst5, lst4>::type,
    mhn::cons<x0, mhn::cons<x1, mhn::cons<x5, mhn::cons<x6, mhn::cons<
      x0, mhn::cons<x1, mhn::cons<x2, mhn::cons<x3, mhn::cons<x4>>>>
    >>>>>
  >();

  test_eq_types<typename mhn::push_front<lst1, x7>::type, mhn::cons<x7>>();
  test_eq_types<
    typename mhn::push_front<lst3, x7>::type,
    mhn::cons<x7, mhn::cons<x0, mhn::cons<x1>>>
  >();

  test_eq_types<typename mhn::push_back<lst1, x7>::type, mhn::cons<x7>>();
  test_eq_types<
    typename mhn::push_back<lst3, x7>::type,
    mhn::cons<x0, mhn::cons<x1, mhn::cons<x7>>>
  >();
  ...
  test_eq_types<
    ...
    mhn::make_seq_t<mhn::linked_list_tag, x7>
  >();
  test_eq_types<
  ...
  test_eq_types<
    ...
    mhn::make_seq_t<mhn::linked_list_tag, x7, x0>
  >();
  test_eq_types<
    typename mhn::insert<lst2, mhn::size_c<1>, x7>::type,
    mhn::make_seq_t<mhn::linked_list_tag, x0, x7>
  >();
  test_eq_types<
    typename mhn::insert<lst3, mhn::size_c<0>, x7>::type,
    mhn::make_seq_t<mhn::linked_list_tag, x7, x0, x1>
  >();
  test_eq_types<
    typename mhn::insert<lst3, mhn::size_c<1>, x7>::type,
    mhn::make_seq_t<mhn::linked_list_tag, x0, x7, x1>
  >();
  test_eq_types<
    typename mhn::insert<lst3, mhn::size_c<2>, x7>::type,
    mhn::make_seq_t<mhn::linked_list_tag, x0, x1, x7>
  >();
  ...
  test_eq_types<
    ...
    mhn::make_seq_t<mhn::linked_list_tag>
  >();
  test_eq_types<
    typename mhn::erase<lst3, mhn::size_c<0>>::type,
    mhn::make_seq_t<mhn::linked_list_tag, x1>
  >();
  test_eq_types<
    typename mhn::erase<lst3, mhn::size_c<1>>::type,
    mhn::make_seq_t<mhn::linked_list_tag, x0>
  >();


  test_eq_types<
    typename mhn::mident<mhn::linked_list_tag>::type, mhn::null_type
  >();
  ...
  test_eq_types<
    ...
    mhn::make_seq_t<mhn::linked_list_tag, res0<x0>>
  >();
  test_eq_types<
    typename mhn::transform<res0_q, lst3>::type,
    mhn::make_seq_t<mhn::linked_list_tag, res0<x0>, res0<x1>>
  >();
  ...
  test_eq_types<
    typename mhn::mbind<
      ...
      monadic_fn_1
    >::type,
    mhn::cons<x0, mhn::cons<x0, mhn::cons<x1, mhn::cons<x1>>>>
  >();
  test_eq_types<
    typename mhn::mbind<
      mhn::cons<x2>,
      ...
      monadic_fn_1
    >::type,
    mhn::cons<x2, mhn::cons<x2, mhn::cons<x2, mhn::cons<x2>>>>
  >();
  test_eq_types<
    typename mhn::mbind<
      mhn::cons<x3, mhn::cons<x4>>,
      monadic_fn_1,
      monadic_fn_1
    >::type,
    mhn::cons<x3, mhn::cons<x3, mhn::cons<x3, mhn::cons<x3, mhn::cons<
      x4, mhn::cons<x4, mhn::cons<x4, mhn::cons<x4>>>
    >>>>>
  >();
  test_eq_types<
    typename mhn::mbind<
      mhn::cons<x5, mhn::cons<x5>>,
      monadic_fn_1,
      monadic_fn_2
    >::type,
    mhn::null_type
