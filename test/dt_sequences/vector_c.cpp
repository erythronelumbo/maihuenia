...
{
  using ivec1 = mhn::vector_c<T>;
  using ivec2 = mhn::vector_c<T, 0>;
  using ivec3 = mhn::vector_c<T, 0, 1>;
  using ivec4 = mhn::vector_c<T, 0, 1, 2, 3, 4>;
  using ivec5 = mhn::vector_c<T, 100, 99, 98>;

  using tvec1 = mhn::vector<>;
  using tvec2 = mhn::vector<mhn::integer_c<T, 0>>;
  using tvec3 = mhn::vector<mhn::integer_c<T, 0>, mhn::integer_c<T, 1>>;
  using tvec4 = mhn::vector<
    mhn::integer_c<T, 0>, mhn::integer_c<T, 1>, mhn::integer_c<T, 2>,
    mhn::integer_c<T, 3>, mhn::integer_c<T, 4>
  >;
  using tvec5 = mhn::vector<
    mhn::integer_c<T, 100>, mhn::integer_c<T, 99>, mhn::integer_c<T, 98>
  >;

  using ivec1a = mhn::vector_c<U>;
  using ivec2a = mhn::vector_c<U, 0>;
  using ivec3a = mhn::vector_c<U, 0, 1>;
  using ivec4a = mhn::vector_c<U, 0, 1, 2, 3, 4>;
  using ivec5a = mhn::vector_c<U, 100, 99, 98>;

  using tvec1a = mhn::vector<>;
  using tvec2a = mhn::vector<mhn::integer_c<U, 0>>;
  using tvec3a = mhn::vector<mhn::integer_c<U, 0>, mhn::integer_c<U, 1>>;
  using tvec4a = mhn::vector<
    mhn::integer_c<U, 0>, mhn::integer_c<U, 1>, mhn::integer_c<U, 2>,
    mhn::integer_c<U, 3>, mhn::integer_c<U, 4>
  >;
  using tvec5a = mhn::vector<
    mhn::integer_c<U, 100>, mhn::integer_c<U, 99>, mhn::integer_c<U, 98>
  >;
  ...
  test_equality<
    ivec1, ivec2, ivec3, ivec4, ivec5,
    tvec1a, tvec2a, tvec3a, tvec4a, tvec5a
  >();
  test_equality<
    ivec1a, ivec2a, ivec3a, ivec4a, ivec5a,
    tvec1a, tvec2a, tvec3a, tvec4a, tvec5a
  ...
  test_eq_types<
    typename mhn::pop_front<ivec1>::type, mhn::vector_c<T>
  >();
  test_eq_types<
    typename mhn::pop_front<ivec2>::type, mhn::vector_c<T>
  >();
  test_eq_types<
    typename mhn::pop_front<ivec3>::type, mhn::vector_c<T, 1>
  >();
  test_eq_types<
    typename mhn::pop_front<ivec4>::type, mhn::vector_c<T, 1, 2, 3, 4>
  >();
  ...
  test_eq_types<
    ...
    mhn::vector_c<T, 0, 1, 100, 99, 98>
  >();
  test_eq_types<
    typename mhn::concat<ivec3, ivec5, ivec4>::type,
    mhn::vector_c<T, 0, 1, 100, 99, 98, 0, 1, 2, 3, 4>
  >();
}
